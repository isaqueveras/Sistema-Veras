<?php
  ...
  $id = $_GET['id']; 
  $resultado = mysql_query("SELECT * FROM agosto WHERE id='$id' LIMIT 1");
...
<main class="app-content">
    <div class="clearfix"></div>
      <div class="tile">
          <h3 class="tile-title"><i class="fa fa-clock-o"> </i> HORÁRIO DE AGOSTO
          ...
          <div class="table-responsive table-hover">
              ...
              <a href="mes.php?mes=20"><button type="button" class="btn btn-sm btn-outline-danger"><i class="fa fa-fw fa-lg fa-chevron-left"></i>Voltar</button></a>
            </div>
          </div>
    </main>
