<?php 
  $id = $_GET['id']; 
  $resultado = mysql_query("SELECT * FROM fevereiro WHERE id='$id' LIMIT 1");
...
<main class="app-content">
  <div class="clearfix"></div>
    <div class="tile">
        <h3 class="tile-title"><i class="fa fa-clock-o"> </i> HORÁRIO DE FEVEREIRO
          <a href="cad_mes.php?mes=<?php echo $_GET['mes']; ?>"><button class="btn btn-sm btn-outline-primary right" type="button">Cadastrar</button></a></h3>
        <div class="table-responsive table-hover">
          <table class="table table-striped" data-toggle="buttons">
            ...
            <a href="mes.php?mes=14"><button type="button" class="btn btn-sm btn-outline-danger"><i class="fa fa-fw fa-lg fa-chevron-left"></i>Voltar</button></a>
          </div>
        </div>
    </main>
