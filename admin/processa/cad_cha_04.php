<?php  
    ...
    $query = mysql_query("INSERT INTO abril (dia,turma_1,turma_2,turma_3,turma_4,turma_5,turma_6,turma_7,turma_8,turma_9,created) VALUES('$dia','$turma_1','$turma_2','$turma_3','$turma_4','$turma_5','$turma_6','$turma_7','$turma_8','$turma_9',NOW())");

    if (mysql_affected_rows() != 0):
        $_SESSION['proc'] = "Horário do dia $dia cadastrado com sucesso!";
        header("Location: ../mes.php?mes=16");         
    else:
