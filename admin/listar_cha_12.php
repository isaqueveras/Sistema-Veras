<?php 
  ...
  $resultado = mysql_query("SELECT * FROM dezembro ORDER BY 'id'");
  $linhas = mysql_num_rows($resultado);
?>
<main class="app-content">
<div class="clearfix"></div>
    <div class="tile">
    	<h3 class="tile-title"><i class="icon fa fa-clock-o"></i> Listar Horários de Dezembro <a href="cad_mes.php?mes=12"><button class="btn btn-outline-info right">Cadastrar</button></a></h3>
		<?php 
			  ...
			  while($linhas = mysql_fetch_array($resultado)){
				echo "<tr>";
				  echo "<td>Chamada do dia <strong>".$linhas['dia']."</strong></td>"; ?>
					<td> 
					  <a href='mes.php?mes=12&id=<?php echo $linhas['id']; ?>'>
						<button type='button' class='btn btn-sm btn-outline-info'><i class="fa fa-fw fa-lg fa-chevron-right"></i>Entrar</button>
					  </a>

					  <a href='processa/apagar_cha_12.php?id=<?php echo $linhas['id']; ?>' data-toggle="modal" data-target="#apagar_dia-<?php echo $linhas['id']; ?>">
						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-footer">
						        ...
						        <a href="processa/apagar_cha_12.php?id=<?php echo $linhas['id']; ?>" class="btn btn-outline-primary"><i class="fa fa-check"></i> Sim</a>
						      </div>
