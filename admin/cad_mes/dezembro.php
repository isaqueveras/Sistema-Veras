...
<main class="app-content">
    <div class="clearfix"></div>
      <div class="tile">
        <form action="processa/cad_cha_12.php" method="POST">
          <h3 class="tile-title"><i class="fa fa-clock-o"> </i> CADASTRAR HORÁRIO DE ALMOÇO - DEZEMBRO</h3>
          <div class="table-responsive table-striped">
            ...
            <a href="mes.php?mes=24"><button type="button" class="btn btn-outline-danger"><i class="fa fa-fw fa-lg fa-chevron-left"></i>Voltar</button></a>
        </form>
    </div>
</main>